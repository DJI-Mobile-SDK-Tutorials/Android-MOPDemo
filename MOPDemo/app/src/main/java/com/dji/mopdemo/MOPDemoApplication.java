...
public class MOPDemoApplication extends Application {

    private static final String TAG = MOPDemoApplication.class.getName();
    ...
    public MOPDemoApplication(Application mApplication) {
